...
import { addNewSurvey, changeSurveyStatus, deleteSurvey, getAllSurvey, getAllSurveyDate, getSurveyById, updateNewSurvey } from '../controller/inspectionController';
...
router.post('/getsurveydate', getAllSurveyDate)
